...
def list_extractor_provider():
    ...
    with open("../DATAPROVIDER", 'r', encoding='utf-8') as file:  # Make sure to specify the correct file path
...
def create_popup():
    ...
    create_button(popup, "ROT Tools", 3, 2, start_another_python_file)
